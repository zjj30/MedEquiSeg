...
| P0 | Clean clone cannot reproduce the release | Pin the upstream CausalCLIPSeg source, fix script entry order, regenerate manifest, and run clean-clone smoke checks | Clean-clone log and hashes | Dependency pinned; remaining checks pending |
